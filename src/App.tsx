...
const CompanyDeviceApprovals = lazyWithLog(() => import("./pages/CompanyDeviceApprovals"), 'CompanyDeviceApprovals');
        ...
        <BrowserRouter>
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/company/devices" element={<CompanyDeviceApprovals />} />
